<%@ Page Title="Contract Outstanding Report" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ContractOutstandingByDate.aspx.cs" Inherits="Report.Operation.LoanOutstandingByDate" %>
