...
{
    public partial class DisbursementConsolidationAsOf : System.Web.UI.Page
    {
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            var sql = "DisbursementConsolidationAsOf";
        ...
        private void GenerateReport(DataTable dt)
        {
            ...
            var ds = new ReportDataSource("DisbursementConsolidationAsOfDS", dt);

            DataHelper.generateOperationReport(ReportViewer1, "DisbursementConsolidationAsOf", reportParameters, ds);
        }
    }
}