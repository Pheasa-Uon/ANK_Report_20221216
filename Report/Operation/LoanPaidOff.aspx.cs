...
{
    public partial class LoanPaidOff : System.Web.UI.Page
    {
        ...
        private void GenerateReport(DataTable dt)
        {
            ...
            var ds = new ReportDataSource("LoanPaidOffDS", dt);

            DataHelper.generateOperationReport(ReportViewer1, "LoanPaidOff", reportParameters, ds);
        }
    }
}