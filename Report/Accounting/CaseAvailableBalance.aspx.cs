...
{
    public partial class CaseAvailableBalance : System.Web.UI.Page
    {
        ...
        private void GenerateReport(DataTable dt)
        {
            ...
            var ds = new ReportDataSource("CaseAvailableBalanceDS", dt);

            DataHelper.generateAccountingReport(ReportViewer1, "CaseAvailableBalance", reportParameters, ds);
        }
    }
}